...
$(document).ready(function() {
  ...
  $('#fc-default').fullCalendar({
    ...
    eventSources: [{
      url: "allrecords", // use the `url` property  // bath data
      color: '#3b7fef', // an option!
      textColor: 'black' // an option!
    }]
  });

  /************************************
   *				Default	room mgr			* done
   ************************************/
  $('#fc-defaultroom').fullCalendar({
    ...
    eventLimit: true, // allow "more" link when too many events
    eventSources: [{
      url: "calendarsessionall", // use the `url` property  // bath data
      color: '#3b7fef', // an option!
  ...
  /************************************
   *				Default	room branch			* done
   ************************************/
  $('#fc-defaultroombranch').fullCalendar({
    ...
    eventLimit: true, // allow "more" link when too many events
    eventSources: [{
      url: "calendarsessionbrnach", // use the `url` property  // bath data
      color: '#3b7fef', // an option!
      textColor: '#000' // an option!
    }]
   ...
   *				Default	student mgr			*
   ************************************/
  $('#fc-mgrstudent').fullCalendar({

    header: {
      left: 'prev,next today',
      center: 'title',
      right: 'month,basicWeek,3days,basicDay,list',
      locale: 'en'
    },
    editable: true,
    eventLimit: true, // allow "more" link when too many events
    timeFormat: 'H(:mm)',
    eventSources: [{
      url: "/" + lang + "/calendarsessionall/" + id + "/", // use the `url` property // bath data
      color: '#93b5ed', // an option!
      textColor: '#000' // an option!
    }]
  });
